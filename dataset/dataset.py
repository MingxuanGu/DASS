...
def init_concat_dataset(cfg, plabel_path=None, source_plabel_path=None, selected=None, centroid=None, wei_path=None,
                        fuse=False, target_selected=None, source_list='none', target_list='none'):
...
def init_source_dataset(cfg, plabel_path=None, selected=None, fuse=False, source_list=None):
    ...
    if cfg.source == 'synthia':
        ...
        cfg.num_classes = 19
    cfg.source_size = source_env.input_size  # 1280, 720
    cfg.target_size = target_env.input_size  # 1024, 512
    cfg.source_data_dir = source_env.data_dir
    cfg.source_data_list = source_env.data_list
    cfg.target_data_dir = target_env.data_dir
    cfg.target_data_list = target_env.data_list
...
def init_test_dataset(config, dataset_name, set, selected=None, prop=None, label_ori=None, fuse=False, batchsize=1,
                      list_path='none'):
